...
cells
   ...
   :add_segment('battery_text', '', colors.battery, attr(attr.intensity('Normal')))
   :add_segment('date_icon', ICON_DATE .. '  ', colors.date, attr(attr.intensity('Normal')))
   :add_segment('date_text', '', colors.date, attr(attr.intensity('Normal')))
